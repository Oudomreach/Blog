...
<?php 
    ...
    if(isset($_GET['cat_id']) ){
        ...
        $posts = $conn->query("SELECT posts.id AS id, 
        ...
        header('location: http://localhost/CleanBlog/404.php');
    }
...
<div class="row gx-4 gx-lg-5 justify-content-center">
        ...
        <?php foreach($rows as $row): ?>
            ...
            <div class="post-preview">
                <a href="http://localhost/CleanBlog/categories/category.php?cat_id=<?php echo $row->id; ?>">
                    <h2 class="post-title"><?php echo $row->title; ?></h2>
                    <h3 class="post-subtitle"><?php echo $row->subtitle; ?></h3>
                </a>
                <p class="post-meta">
                    Posted by
                    <b><a href="#!"><?php echo $row->user_name; ?></a></b>
